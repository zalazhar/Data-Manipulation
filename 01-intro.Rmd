...
In this book we cover the most used formulas of data manipulation, and show how to implement the formulas with R and Python.  The formulas are classified into the following sections: 
...
- **Column formulas**
    ...
    - **_Transform_**: Converting, Comparing, Restorting, Lagging, Missing Value, Normalizing/Denormalizing, One To Many, Many to One, String manipulation, Subsetting.
